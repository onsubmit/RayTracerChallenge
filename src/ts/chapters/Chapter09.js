...
class Chapter09 {
    constructor() {
        ...
        this.getWorld = () => {
            ...
            ceiling.transformation = Matrix_1.default.getTranslationMatrix(0, 11, 0);
            ceiling.material.color = new Color_1.default(1, 0.9, 0.9);
        ...
        this.run = () => {
            ...
            const painter = new CanvasPainter_1.default("canvas9");
